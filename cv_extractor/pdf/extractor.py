...
--------------------------
Extract text from PDFs using PyMuPDF and Gemini OCR for scanned documents.
"""
...
from cv_extractor.config import GOOGLE_API_KEY, POPPLER_PATH
...
class ExtractFromPDF:
    def __init__(self, raw_folder=None, output_folder=None, poppler_path=None, api_key=None):
        ...
        self.poppler_path = poppler_path or POPPLER_PATH
...
if __name__ == "__main__":
    from cv_extractor.config import INPUT_FOLDER, OUTPUT_FOLDER
